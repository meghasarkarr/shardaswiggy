...
class Parse{
    ...
    void parse_dishes(){
        try {
            FileReader fr = new FileReader("C:\\Users\\megha\\IdeaProjects\\shardaswiggy\\data\\Dish.csv");
    ...
    void parse_restaurant(){
        try{
            FileReader f = new FileReader("C:\\Users\\megha\\IdeaProjects\\shardaswiggy\\data\\Kitchen.csv");
